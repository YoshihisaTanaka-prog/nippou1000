...
class ToDosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do" do
    assert_difference("ToDo.count") do
      post to_dos_url, params: { to_do: { is_finished: @to_do.is_finished, name: @to_do.name, time_limit: @to_do.time_limit } }
    end
  ...
  test "should update to_do" do
    patch to_do_url(@to_do), params: { to_do: { is_finished: @to_do.is_finished, name: @to_do.name, time_limit: @to_do.time_limit } }
