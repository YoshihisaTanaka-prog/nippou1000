...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { first_comment: @main.first_comment, second_comment: @main.second_comment } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { first_comment: @main.first_comment, second_comment: @main.second_comment } }
